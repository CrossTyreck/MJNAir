...
{ 
	...
	public int particlesPerArm = 2;
 
	// The separation between particles.
	public float particleSeparation = 0.5f;
	...
	public const int Max_numArms = 6;
	public const int Min_numPPA = 1;
	public const int Max_numPPA = 20;
